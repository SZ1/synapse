...
class PasswordResetSubmitTokenServlet(RestServlet):
    ...
    async def on_GET(self, request, medium):
        ...
        respond_with_html(
            request, 200, self._confirmation_template.render(**template_vars)
        )
...
class PasswordResetConfirmationSubmitTokenServlet(RestServlet):
    ...
    def __init__(self, hs):
        ...
        if hs.config.threepid_behaviour_email == ThreepidBehaviour.LOCAL:
            ...
            self._email_password_reset_template_success_html_content = (
    ...
    async def on_POST(self, request):
        ...
        try:
            ...
            html = self._email_password_reset_template_success_html_content
            status_code = 200
